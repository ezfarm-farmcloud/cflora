...
#define	ChkCanTimeOut()				  (regSystemStatus->bCanTimeOut)
...
extern BOOL PacketStreaming( LPCOMMPACKET pPacket );
extern void UARTSendPacket( LPCOMMPACKET pPacket, BOOL b );
