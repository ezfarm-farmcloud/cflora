...
#define FSMC_Bank1_NORSRAM1                             ((u32)0x00000000)	// 0x60000000
#define FSMC_Bank1_NORSRAM2                             ((u32)0x00000002)	// 0x64000000
#define FSMC_Bank1_NORSRAM3                             ((u32)0x00000004)	// 0x68000000
#define FSMC_Bank1_NORSRAM4                             ((u32)0x00000006)	// 0x6c000000
#define FSMC_Bank2_NAND                                 ((u32)0x00000010)	// 0x70000000
#define FSMC_Bank3_NAND                                 ((u32)0x00000100)	// 0x80000000
#define FSMC_Bank4_PCCARD                               ((u32)0x00001000)	// 0x90000000
